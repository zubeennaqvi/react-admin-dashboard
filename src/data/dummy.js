...
export const EditorData = () => (
  <div>
    <h3>
      Welcome to Zubeen Naqvi's Admin Dashboard!

      This platform is built using React.js with powerful UI components, advanced charting libraries, and responsive design.

      👨‍💻 Features:
      - Dynamic Charts and Data Tables
      - Interactive Kanban Board
      - Calendar Integration
      - Sales, Finance, and Project Insights
      ...
      Feel free to explore and manage your data effectively. Happy Dashboarding!
    </h3>
  </div>
);
